module github.com/sebach1/coding-challenge/microservices/backend/films
...
require (
	...
	github.com/sebach1/coding-challenge/microservices/pb v0.0.0-20201206201616-282938a9970a
