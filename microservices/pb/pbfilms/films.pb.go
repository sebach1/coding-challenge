...
type CreateJoinPeopleFilmRequest struct {
	...
	FilmExternalReference   uint64 `protobuf:"varint,1,opt,name=film_external_reference,json=filmExternalReference,proto3" json:"film_external_reference,omitempty"`
	PeopleExternalReference uint64 `protobuf:"varint,2,opt,name=people_external_reference,json=peopleExternalReference,proto3" json:"people_external_reference,omitempty"`
}
...
func (x *CreateJoinPeopleFilmRequest) GetFilmExternalReference() uint64 {
	if x != nil {
...
func (x *CreateJoinPeopleFilmRequest) GetPeopleExternalReference() uint64 {
	if x != nil {
...
var file_films_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x66, 0x69,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x17, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x45, 0x78,
